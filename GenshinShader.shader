    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {   
                ...
                //根据半兰伯特采样ramp图的x坐标，根据材质属性采样ramp图的y坐标
                ...
                // 最终计算，根据自己设置的阈值step，没到达就用rampColor * BaseColor * _ShadowColor，不然就BaseColor
                half4 FinalRamp = lerp(rampColor * BaseColor * _ShadowColor, BaseColor, step(_RampShadowRange, halfLambert * ShadowAO));

                //— — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — — —
                // Hair Ramp 和Base Ramp同理，出了ramp图不同，头发要更深一些
                #if _SHADERENUM_HAIR
                    if (_IsNight == 0.0)

...
public class GrassComputeScript : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        //LRC add
        m_InstantiatedComputeShader.SetTexture(m_IdGrassKernel, "_flowmap", grasswild);
    ...
    private void LateUpdate()
    {
        ...
        // Buffer with arguments, bufferWithArgs, has to have four integer numbers at given
        // argsOffset offset: vertex count per instance, instance count, start vertex location, and start instance location. 
